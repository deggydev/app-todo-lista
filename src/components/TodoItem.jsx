...
function TodoItem(props){
    ...
    const { id, actividad, isComplete, fechaCreacion, onToggleComplete, onDeleteTodo } = props;
    return (
        <div style={{ display: 'flex', justifyContent:'space-between', alignItems: 'center', gap: '15px', padding: '10px' }}>
            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                    <p style={{ margin: 0, fontWeight: 'bold', textDecoration: isComplete ? 'line-through' : 'none' }}>{actividad}</p>
